...
func (rt *GseTokenizer) Tokenize(input []byte) analysis.TokenStream {
	...
	segPos := rt.seg.Pos(string(input))
...
func init() {
	registry.RegisterTokenizer(Name, GseTokenizerConstructor)
}
