    ...
    <template #wrapper>
      <el-card class="box-card">
        ...
        <el-row :gutter="10" class="mb8">
          <el-col :span="1.5">
            <el-button
              v-permisaction="['umsmemberlevel:umsmemberlevel:add']"
              type="primary"
              icon="el-icon-plus"
              size="mini"
              @click="handleAdd"
          ...
          <el-col :span="1.5">
            <el-button
              v-permisaction="['umsmemberlevel:umsmemberlevel:edit']"
              type="success"
              icon="el-icon-edit"
              size="mini"
              :disabled="single"
          ...
          <el-col :span="1.5">
            <el-button
              v-permisaction="['umsmemberlevel:umsmemberlevel:remove']"
              type="danger"
              icon="el-icon-delete"
              size="mini"
              :disabled="multiple"
...
<script>
import { addUmsMemberLevel, delUmsMemberLevel, getUmsMemberLevel, listUmsMemberLevel, updateUmsMemberLevel } from '@/api/member/umsmemberlevel'
...
export default {
  ...
  methods: {
    ...
    getList() {
      this.loading = true
      listUmsMemberLevel(this.addDateRange(this.queryParams, this.dateRange)).then(response => {
        this.umsmemberlevelList = response.data
