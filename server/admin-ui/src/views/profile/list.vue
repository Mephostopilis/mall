    ...
    <div>
        <div class="crumbs">
            <el-breadcrumb separator="/">
                <el-breadcrumb-item> <i class="el-icon-lx-cascades"></i> 快递公司管理 </el-breadcrumb-item>
            </el-breadcrumb>
        </div>
        <div class="container">
            <div class="handle-box">
                <el-input v-model="query.name" placeholder="地区" class="handle-input mr10" style="width: 240px"></el-input>
            ...
            >
                ...
                <el-table-column prop="website" label="网址" align="center"></el-table-column>
        ...
        <el-dialog
            ...
            width="900px"
        >
            <el-form :model="form.data" :rules="form.rules" ref="form" label-width="100px" :disabled="!editAbleble">
                <el-row>
                    <el-col :span="8">
                ...
                <el-row>
                    <el-col :span="8">
                        <el-form-item label="网址" prop="website">
                            <el-input v-model="form.data.website"></el-input>
                        </el-form-item>
                    </el-col>
                </el-row>
                <el-row>
            ...
            <span slot="footer" class="dialog-footer">
                <el-button @click="saveEdit" :disabled="!editAbleble">保存</el-button>
