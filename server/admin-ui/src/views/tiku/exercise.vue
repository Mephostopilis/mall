    ...
    <template #wrapper>
      <el-card class="box-card">
        ...
        <el-row :gutter="10" class="mb8">
          <el-col :span="1.5">
            <el-button
              v-permisaction="['exercise:exercise:add']"
              type="primary"
              icon="el-icon-plus"
              size="mini"
              @click="handleAdd"
          ...
          <el-col :span="1.5">
            <el-button
              v-permisaction="['exercise:exercise:edit']"
              type="success"
              icon="el-icon-edit"
              size="mini"
              :disabled="single"
          ...
          <el-col :span="1.5">
            <el-button
              v-permisaction="['exercise:exercise:remove']"
              type="danger"
              icon="el-icon-delete"
              size="mini"
              :disabled="multiple"
...
export default {
  ...
  methods: {
    ...
    getList() {
      this.loading = true
      listExercise(this.addDateRange(this.queryParams, this.dateRange)).then(response => {
